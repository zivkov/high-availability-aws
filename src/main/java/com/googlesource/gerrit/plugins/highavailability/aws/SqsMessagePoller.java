        ...
        sqs.receiveMessage(
                req ->
                    req.queueUrl(queueInfo.url())
                        .visibilityTimeout((int) config.limits().visibilityTimeout().getSeconds())
                        .waitTimeSeconds((int) config.limits().waitTime().getSeconds())
                        .maxNumberOfMessages(config.limits().maxNumberOfMessages())
